...
public class RedFragment extends Fragment {
   ...
   View farg1=inflater.inflate(R.layout.fragment_red,container,false);

        TextView texto=farg1.findViewById(R.id.txtTexto);
        EditText cadena=farg1.findViewById(R.id.edtNombre);
        Button Boton=farg1.findViewById(R.id.btnBoton);
        ...
        Boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intento=new Intent(getActivity(),MainActivity.class);
                 intento.putExtra("nombre",cadena.getText().toString());
